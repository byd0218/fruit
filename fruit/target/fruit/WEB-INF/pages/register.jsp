...
<body>
	<div id="content">
		<div id="form">
		  <h1>用户注册</h1><br/>
		  <form action="register" method="post" id="myform"  onsubmit="return validate()">
		  	  ...
		  	  姓名:<input type="text" id="name" name="name" style="width:190px;
		  	  height:26px;margin-top:8px;margin-left:54px;"/><br/>
		  	  手机号:<input type="text" id="telephone" name="telephone" style="width:190px;
		  	  height:26px;margin-top:8px;margin-left:39px;"/><br/>
			  <input type="submit" value="注册" style="width:50px; height:30px; margin-top:8px;"/>
			  <a href="${pageContext.request.contextPath}/user/returnLogin">返回登录</a>
		  </form>
		  <!-- 显示错误信息 -->
